...
Classe responsável pela interface gráfica customizada da Classe LongJump no inspector
...
[CustomEditor(typeof(LongJump))]
public class LongJumpEditor : Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		EditorGUILayout.LabelField ("Long Jump", EditorUITextStyles.titleStyle);
		EditorGUILayout.Space ();
		...
		EditorGUILayout.LabelField ("Controla o comportamento de salto longo quando o controle é pressionado. " +
									...
									"do salto nesta ação também é ajustável, assim como o tempo do comando pressionado " +
									"e o multiplicador da força do salto", EditorUITextStyles.messageStyle);
		EditorGUILayout.Space ();
		...
		EditorGUILayout.BeginVertical ("box");
		SerializedProperty jumpBoostMultiplier = serializedObject.FindProperty ("jumpBoostMultiplier");
		EditorGUILayout.Slider(jumpBoostMultiplier, 0.00f, 5.00f, "Mult. do Boost");
		SerializedProperty longJumpDelay = serializedObject.FindProperty ("longJumpDelay");
		EditorGUILayout.Slider(longJumpDelay, 0.00f, 1.00f, "Tempo no Controle");
		EditorGUILayout.EndVertical ();

		/////////////////////////////////////////////////////////////////////////////////////////
		GUIContent property = new GUIContent ();
		SerializedProperty canLongJump = serializedObject.FindProperty ("canLongJump");
		property.text = "Pode Saltar?";
		EditorGUILayout.PropertyField (canLongJump, property);
		SerializedProperty isLongJumping = serializedObject.FindProperty ("isLongJumping");
		property.text = "Está Saltando?";
		EditorGUILayout.PropertyField (isLongJumping, property);
		////////////////////////////////////////////////////////////////////////////////////////
